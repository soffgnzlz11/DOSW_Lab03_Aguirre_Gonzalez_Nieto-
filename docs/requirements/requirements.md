...
- El segundo deberia Comenzar ser la creacion de los equipos ya que son parte primordial del todo el sistema y un elemento base para la creacion de todo torneo.
